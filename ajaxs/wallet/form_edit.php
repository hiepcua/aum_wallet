...
$res_Customer = SysGetList('tbl_customer', array(), "AND `username`=".$GetID);
...
<form name="frm_action" id="frm_action" action="" method="post" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" name="phone" class="form-control" value="<?php echo $row['phone'];?>" placeholder="Số điện thoại">
	</div>

	<div class="form-group">
		<label>Tên khách hàng</label>
		<input type="text" name="fullname" class="form-control" value="<?php echo $row['fullname'];?>" placeholder="Tên khách hàng">
	</div>
	...
	$(document).ready(function(){
		$("form#frm_action").submit(function(e) {
			if(validForm()){
				...
				var _url="<?php echo ROOTHOST;?>ajaxs/customer/process_edit.php";
				$.ajax({
					url: _url,
					type: 'POST',
					data: formData,
